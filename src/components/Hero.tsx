...
const slides: Array<{ image: string; heading: LangMap; cta: LangMap; link: string }> = [
  {
        ...
        heading: { TR: 'YENI KOLEKSIYON', EN: 'NEW COLLECTION', DE: 'NEUE KOLLEKTION', AR: 'مجموعة جديدة' },
        cta: { TR: 'KESFET', EN: 'DISCOVER', DE: 'ENTDECKEN', AR: 'اكتشف' },
        link: '/category/new',
  },
  {
        image: '/images/category-ring-4.jpg',
        heading: { TR: 'OZEL TASARIM', EN: 'SPECIAL DESIGN', DE: 'SONDERDESIGN', AR: 'تصميم خاص' },
        cta: { TR: 'KESFET', EN: 'DISCOVER', DE: 'ENTDECKEN', AR: 'اكتشف' },
                  ...
                  {slides.map((_, i) => (
                      <button
                                    ...
                                    style={{
                                                    ...
                                                    height: '8px',
                                                    borderRadius: '4px',
                                                    background: current === i ? '#FFFFFF' : 'rgba(255,255,255,0.5)',
                                                    border: 'none',
                                                    cursor: 'pointer',
