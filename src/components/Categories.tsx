...
const categories = [
    { id: 'ring', name: { TR: 'Yuzuk', EN: 'Rings', DE: 'Ringe', AR: 'خواتم' }, image: '/images/category-ring-1.jpg' },
    { id: 'earring', name: { TR: 'Kupe', EN: 'Earrings', DE: 'Ohrringe', AR: 'أقراط' }, image: '/images/category-ring-4.jpg' },
    { id: 'bracelet', name: { TR: 'Bilezik', EN: 'Bracelets', DE: 'Armbaender', AR: 'أساور' }, image: '/images/category-ring-3.jpg' },
    { id: 'necklace', name: { TR: 'Kolye', EN: 'Necklaces', DE: 'Halsketten', AR: 'قلادات' }, image: '/images/category-ring-6.jpg' },
    { id: 'diamond', name: { TR: 'Pirlanta', EN: 'Diamond', DE: 'Diamanten', AR: 'ألماس' }, image: '/images/category-ring-7.jpg' },
