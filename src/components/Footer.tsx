...
const content: Record<Language, FooterContent> = {
      ...
      DE: {
              ...
              col1Links: [
                  ...
                  { label: 'Filialen', href: '#' },
                  { label: 'Grosshandel & Franchise', href: '#' },
                  { label: 'Kontakt', href: '#' },
              ...
              col3Links: [
                  { label: 'Bestellung & Rueckgabe', href: '#' },
                  { label: 'Reparatur & Pflege', href: '#' },
                  { label: 'Ringgroessenrechner', href: '#' },
              ...
              col4Links: [
                  ...
                  { label: 'Datenschutzerklaerung', href: '#' },
                  { label: 'AGB', href: '#' },
                      ],
              newsletter: 'Newsletter',
              newsletterSub: 'Als Erste ueber neue Designs informiert werden',
      ...
      AR: {
              ...
              col2Links: [
                  { label: 'التصاميم', href: '#' },
                  { label: 'اسئلة شائعة', href: '#' },
                  { label: 'احجز موعدا', href: '#' },
                  { label: 'بخاخ العناية', href: '#' },
                  { label: 'تعليمات العناية', href: '#' },
                      ],
              col3Title: 'خدمة العملاء',
              col3Links: [
                  { label: 'سياسة الطلب والارجاع', href: '#' },
                  { label: 'الاصلاح والعناية', href: '#' },
              ...
              newsletterSub: 'كن اول من يعرف التصاميم الجديدة',
              ...
              <footer style={{ backgroundColor: '#111111', color: '#FFFFFF' }}>
                        <div style={{ padding: '64px 48px 48px', display: 'grid', gridTemplateColumns: '1fr 1fr 1fr 1fr 300px', gap: '40px' }}>
                            ...
                            <div key={col.title} style={colStyle}>
                                            <p style={titleStyle}>{col.title}</p>p>
                                {col.links.map((l) => (
                                              <a key={l.label} href={l.href} style={linkStyle}>{l.label}</a>a>
                                            ))}
                            </div>div>
                                    ))}
                                    <div style={colStyle}>
                                                  ...
                                                  <div style={{ display: 'flex' }}>
                                                                  <input
                                                                                    ...
                                                                                    placeholder={c.emailPlaceholder}
                                                                                    style={{ fontFamily: '"Jost", sans-serif', fontSize: '13px', flex: 1, padding: '10px 12px', background: 'rgba(255,255,255,0.1)', border: '1px solid rgba(255,255,255,0.2)', borderRight: 'none', color: '#FFFFFF', outline: 'none' }}
                                                                                  />
                                                                  <button style={{ fontFamily: '"Jost", sans-serif', fontSize: '13px', fontWeight: 500, letterSpacing: '0.5px', textTransform: 'uppercase', background: '#FFFFFF', color: '#111111', border: 'none', padding: '10px 16px', cursor: 'pointer' }}>
                                                                      {c.subscribeBtn}
                                                                  </button>button>
                                                  </div>div>
