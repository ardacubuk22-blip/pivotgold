...
export const SEOSection: React.FC<SEOSectionProps> = ({ lang }) => {
  const content = {
    ...
    EN: {
      ...
      text: 'Pivot Gold is an exclusive jewelry brand that combines modern and timeless designs. Our collections, inspired by famous design lines, offer a unique experience with custom production options.',
    ...
    DE: {
      ...
      text: 'Pivot Gold ist eine exklusive Schmuckmarke, die modernes und zeitloses Design verbindet.',
    ...
    AR: {
      ...
      text: 'Pivot Gold هي علامة تجارية حصرية للمجوهرات تجمع بين التصاميم الحديثة والخالدة.',
  ...
  return (
    <section className="py-20 bg-zinc-50 border-y border-zinc-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h1 className="text-2xl md:text-3xl font-serif text-zinc-900 mb-8 leading-relaxed">
            {content[lang].title}
          </h1>
