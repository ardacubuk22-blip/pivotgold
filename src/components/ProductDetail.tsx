    ...
    return (
          <AnimatePresence>
                <motion.div
                        ...
                        >
                        <div className="absolute inset-0 bg-black/60 backdrop-blur-sm" onClick={onClose}></div>div>
                        <motion.div
                                    ...
                                    {/* Info Section */}
                                              <div className="p-8 md:p-12">
                                                          ...
                                                          <li key={idx} className={`text-xs text-zinc-500 flex items-center ${lang === 'AR' ? 'flex-row-reverse' : ''}`}>
                                                                                  <span className={`w-1 h-1 bg-[#B8962E] rounded-full ${lang === 'AR' ? 'ml-2' : 'mr-2'}`}></span>span>
                                                            {detail}
                                                          </li>li>
                                                        ))}
                                                                                                </ul>ul>
                                                ...
                                                {/* Trust Badges */}
                                                            <div className="grid grid-cols-3 gap-4 border-t border-zinc-100 pt-8">
                                                                            <div className="text-center">
                                                                                              ...
                                                                                              <p className="text-[9px] uppercase tracking-wider text-zinc-500">{labels[lang].shipping}</p>p>
                                                                            </div>div>
                                                                            <div className="text-center">
                                                                                              <RotateCcw size={20} className="mx-auto text-[#B8962E] mb-2" />
                                                                                              <p className="text-[9px] uppercase tracking-wider text-zinc-500">{labels[lang].return}</p>p>
                                                                            </div>div>
                                                                            <div className="text-center">
                                                                                              <ShieldCheck size={20} className="mx-auto text-[#B8962E] mb-2" />
                                                                                              <p className="text-[9px] uppercase tracking-wider text-zinc-500">{labels[lang].warranty}</p>p>
                                                                            </div>div>
                                                            </div>div>
                                              </div>div>
                                  </div>div>
