...
const AnnouncementBar: React.FC<{ lang: Language }> = ({ lang }) => {
  ...
  return (
    <div style={{ backgroundColor: '#111111', height: '36px', display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden' }}>
      <p style={{ fontFamily: '"Jost", sans-serif', fontSize: '11px', fontWeight: 400, color: 'rgba(255,255,255,0.85)', letterSpacing: '0.15em', textTransform: 'uppercase', textAlign: 'center' }}>
        <span style={{ color: '#B8962E', marginRight: '8px' }}>{'◆'}</span>
        {messages[idx]}
        <span style={{ color: '#B8962E', marginLeft: '8px' }}>{'◆'}</span>
      </p>
    </div>
  );
};
...
export default function App() {
  ...
  return (
    <Router>
      <div className="min-h-screen bg-white ltr" dir="ltr">
